...
## Model
www.msaez.io/#/storming/12stmall-lbh-1106
...
cd /bin
./kafka-console-consumer --bootstrap-server localhost:9092 --topic stmalllbh --from-beginning
```
...
- product
```
 http :8088/productManagements id="id" productName="productName" productImg="productImg" stock="stock" 
```
